...
//       )
//       //notification
//       const barangayNotif = await Barangay.findOne({ _id: req.params.id })
//       .populate('message');
...
//             return msg.reason;
//         }));
//             messageNotif = `Your barangay clearance has been ${bClearanceIsVerifiedValue}. Please update your uploaded nbi clearance. Your nbi clearance has ${messages.join(', ')}.`;
//       }
